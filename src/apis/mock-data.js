export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'AnhQuanDev',
    description: 'Trello project by anhquandev',
    type: 'public', // 'private'
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover:
              'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMP3wBcdBLYF16dzosE6g_brBdGv7AmU9LGg&usqp=CAU',
      ...
      },
      {
         ...
         * Cấu trúc Id của cái card này để Unique rất đơn gian, không cần phải làm random phức tạp:
